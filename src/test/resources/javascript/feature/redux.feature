...
Examples: 
	...
	| : do ; -1 if do 12 loop then				| IntegerStack	| [-1]		  | DisplayStack | ["ok", ": do ; -1 if do 12 loop then", "\r", "Control structure mismatch", "\r", "ok"] |
	| : foo .s then						| IntegerStack	| []		  | DisplayStack | ["ok", ": foo .s then", "\r", "Control structure mismatch", "\r", "ok"] |
	| 5 0 do .s ;						| IntegerStack	| [5, 0]	  | DisplayStack | ["ok", "5 0 do .s ;", "\r", "Control structure mismatch", "\r", "ok"] |
	...
	| 8 -1 dup if if 2 0 do * .s if  then loop else min then else if dup then mod then dup * | IntegerStack	| [] | DisplayStack | ["ok", "8 -1 dup if if 2 0 do * .s if  then loop else min then else if dup then mod then dup *", "\r", "Stack Underflow", "\r", "Stack Underflow", "\r", "ok"] |		
...
Examples:
	...
	| 17 eggsize	| ["ok", ": eggsize","\r", "ok", "dup 18 < if .\" reject \" else", "\r", "ok", "dup 21 < if .\" small \" else", "\r", "ok", "dup 24 < if .\" medium \" else", "\r", "ok", "dup 27 < if .\" large \" else", "\r", "ok", "dup 30 < if .\" extra large \" else", "\r", "ok", ".\" error \"", "\r", "ok", "then then then then then drop ;", "\r", "ok", "17 eggsize", "\r", "reject", "\r", "ok"]		|
	| 20 eggsize	| ["ok", ": eggsize","\r", "ok", "dup 18 < if .\" reject \" else", "\r", "ok", "dup 21 < if .\" small \" else", "\r", "ok", "dup 24 < if .\" medium \" else", "\r", "ok", "dup 27 < if .\" large \" else", "\r", "ok", "dup 30 < if .\" extra large \" else", "\r", "ok", ".\" error \"", "\r", "ok", "then then then then then drop ;", "\r", "ok", "20 eggsize", "\r", "small", "\r", "ok"]		|
	| 23 eggsize	| ["ok", ": eggsize","\r", "ok", "dup 18 < if .\" reject \" else", "\r", "ok", "dup 21 < if .\" small \" else", "\r", "ok", "dup 24 < if .\" medium \" else", "\r", "ok", "dup 27 < if .\" large \" else", "\r", "ok", "dup 30 < if .\" extra large \" else", "\r", "ok", ".\" error \"", "\r", "ok", "then then then then then drop ;", "\r", "ok", "23 eggsize", "\r", "medium", "\r", "ok"]		|
	| 26 eggsize	| ["ok", ": eggsize","\r", "ok", "dup 18 < if .\" reject \" else", "\r", "ok", "dup 21 < if .\" small \" else", "\r", "ok", "dup 24 < if .\" medium \" else", "\r", "ok", "dup 27 < if .\" large \" else", "\r", "ok", "dup 30 < if .\" extra large \" else", "\r", "ok", ".\" error \"", "\r", "ok", "then then then then then drop ;", "\r", "ok", "26 eggsize", "\r", "large", "\r", "ok"]		|
	| 29 eggsize	| ["ok", ": eggsize","\r", "ok", "dup 18 < if .\" reject \" else", "\r", "ok", "dup 21 < if .\" small \" else", "\r", "ok", "dup 24 < if .\" medium \" else", "\r", "ok", "dup 27 < if .\" large \" else", "\r", "ok", "dup 30 < if .\" extra large \" else", "\r", "ok", ".\" error \"", "\r", "ok", "then then then then then drop ;", "\r", "ok", "29 eggsize", "\r", "extra large", "\r", "ok"]	|
	| 30 eggsize	| ["ok", ": eggsize","\r", "ok", "dup 18 < if .\" reject \" else", "\r", "ok", "dup 21 < if .\" small \" else", "\r", "ok", "dup 24 < if .\" medium \" else", "\r", "ok", "dup 27 < if .\" large \" else", "\r", "ok", "dup 30 < if .\" extra large \" else", "\r", "ok", ".\" error \"", "\r", "ok", "then then then then then drop ;", "\r", "ok", "30 eggsize", "\r", "error", "\r", "ok"]		|
